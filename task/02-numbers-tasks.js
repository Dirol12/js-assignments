...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  var res1 = Math.sqrt(Math.pow(x1,2)+Math.pow(y1,2));
  var res2 = Math.sqrt(Math.pow(x2,2)+Math.pow(y2,2));
  var res3 = x1*x2 + y1*y2;
  var res = Math.acos ( res3 / (res1*res2));
  return res;
}
